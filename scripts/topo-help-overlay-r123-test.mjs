/* Round 123 verification: HelpOverlay catches up on R121 — edge
 * midpoint count badge became click-to-pin. R122's badge hover
 * is the natural partner of R121 click; doesn't need its own
 * entry. Continues the R59/R62/R65/R70/R78/R81/R87/R91/R109/R118
 * cadence.
 *
 * Ten generations of help-overlay assertions stacked here — any
...
const results = {
  ...
  // R87 / R81 / R78 / R74 / R70 / R65 / R59 priors — 11 generations
...
console.log(`${ok ? '✅' : '❌'} help overlay R123:`, JSON.stringify(results),
  `\n  items=`, items);
process.exit(ok ? 0 : 1);
