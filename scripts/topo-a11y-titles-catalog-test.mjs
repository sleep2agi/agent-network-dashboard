...
const expectedSurfaces = ['canvas scan beam', 'canvas-corner crescent', 'hub-highlight disc', 'legend panel title', 'recent panel title', 'title-block brand logo', 'watermark text'];
...
const results = {
  ...
  has_7_entries:                      Array.isArray(catalog) && catalog.length === 7,
