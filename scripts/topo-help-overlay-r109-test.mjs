/* Round 109 verification: HelpOverlay catches up on R108 — palette
 * gained pin-vendor commands (Anthropic/OpenAI/书生). Continues the
 * R59/R62/R65/R70/R78/R81/R87/R91 docs-catch-up cadence.
 *
 * Stacks eight generations of help-overlay assertions — any future
 * regression that drops an entry will be caught by one of:
 *   R109 (this) → R91 → R87 → R81 → R78 → R74 → R70 → R65 → R59
 */
...
const results = {
  ...
  // R78 / R74 / R70 / R65 / R59 priors — 8 generations now
...
console.log(`${ok ? '✅' : '❌'} help overlay R109:`, JSON.stringify(results),
  `\n  items=`, items);
process.exit(ok ? 0 : 1);
