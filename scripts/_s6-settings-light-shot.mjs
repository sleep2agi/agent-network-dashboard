...
await page.screenshot({ path: '/tmp/anet-mobile-qa/s6-settings-light-1.png', animations: 'disabled', fullPage: false });
await page.evaluate(() => window.scrollBy(0, 700));
await page.waitForTimeout(400);
await page.screenshot({ path: '/tmp/anet-mobile-qa/s6-settings-light-2.png', animations: 'disabled', fullPage: false });
